...
/* @violates @ref Port_Siul2_C_REF_3 Violates MISRA 2004 Required Rule 1.4 */
#define PORT_SIUL2_AR_RELEASE_MINOR_VERSION_C      3
/* @violates @ref Port_Siul2_C_REF_3 Violates MISRA 2004 Required Rule 1.4 */
#define PORT_SIUL2_AR_RELEASE_REVISION_VERSION_C   1
#define PORT_SIUL2_SW_MAJOR_VERSION_C              1
#define PORT_SIUL2_SW_MINOR_VERSION_C              0
#define PORT_SIUL2_SW_PATCH_VERSION_C              1
...
#ifdef PORT_ENABLE_USER_MODE_SUPPORT
    /* Check if the files Port_Siul2.c and RegLockMacros.h are of the same version */
    #if ((PORT_SIUL2_AR_RELEASE_MAJOR_VERSION_C != REGLOCKMACROS_AR_RELEASE_MAJOR_VERSION) || \
         (PORT_SIUL2_AR_RELEASE_MINOR_VERSION_C != REGLOCKMACROS_AR_RELEASE_MINOR_VERSION)    \
        )
        #error "AutoSar Version Numbers of Port_Siul2.c and RegLockMacros.h are different"
    #endif
#else
...
#ifdef PORT_SIUL2_REG_PROT_AVAILABLE
    /** @violates @ref Port_Siul2_C_REF_7 Function-like macro */
    #define Call_Port_Siul2_SetUserAccessAllowed() \
    do{ \
...
* @detail   Port_Siul2_au16GPIODirChangeability variable is only used by Port_Siul2_SetPinDirection, Port_Siul2_Set2PinsDirection
...
LOCAL_INLINE FUNC(void, PORT_CODE) Port_Siul2_Init_UnusedPins
(
    P2CONST(Port_ConfigType, AUTOMATIC,  PORT_APPL_CONST) pConfigPtr
);

LOCAL_INLINE FUNC(void, PORT_CODE) Port_Siul2_Init_ConfiguredPins
(
    P2CONST(Port_ConfigType, AUTOMATIC,  PORT_APPL_CONST) pConfigPtr
);
/*=================================================================================================
...
FUNC( void, PORT_CODE) Port_Siul2_SetUserAccessAllowed(void)
{
    ...
    */
    SET_USER_ACCESS_ALLOWED(SIUL2_BASEADDR, SIUL2_PROT_MEM_U32);
}
#endif /* PORT_SIUL2_REG_PROT_AVAILABLE */
...
* @details      The function Port_Siul2_Init_UnusedPins will initialize ALL Unused Port Pins with the
...
/**
* @brief        Initializes the PORT IP Driver
* @details      The function Port_Siul2_Init_ConfiguredPins will initialize ALL configured Port Pins with the
*               configuration set pointed to by the parameter ConfigPtr.
*
* @param[in]    pConfigPtr  A pointer to the structure which contains initialization parameters
*
...
)
{
...
#ifdef PORT_SIUL2_REG_PROT_AVAILABLE
    /** @violates @ref Port_Siul2_C_REF_9 The comma operator shall not be used. */
    Call_Port_Siul2_SetUserAccessAllowed();
#endif /* PORT_SIUL2_REG_PROT_AVAILABLE */

    /* Initialize All UnUsed Port Pins */
    Port_Siul2_Init_UnusedPins(pConfigPtr);

    /* Initialize All Configured Port Pins */
    Port_Siul2_Init_ConfiguredPins(pConfigPtr);
    ...
    /* Port_Siul2_au16GPIODirChangeability is only used by Port_Siul2_SetPinDirection, Port_Siul2_Set2PinsDirection and Port_Siul2_SetPinMode functions */
...
*
*/
FUNC(Std_ReturnType, PORT_CODE) Port_Siul2_Set2PinsDirection
(
...
)
{
    ...
    * @violates @ref Port_Siul2_C_REF_6 Violates MISRA 2004 Required Rule 17.4
    */
    VAR(uint16, AUTOMATIC) u16PinPad1 = (uint16)pConfigPtr->pUsedPadConfig[Pin1Index].u16SIUPin;
    /**
    * @violates @ref Port_Siul2_C_REF_6 Violates MISRA 2004 Required Rule 17.4
    */
    VAR(uint16, AUTOMATIC) u16PinPad2 = (uint16)pConfigPtr->pUsedPadConfig[Pin2Index].u16SIUPin;
    /* Return value */
    VAR(Std_ReturnType, AUTOMATIC) PinDirError = (Std_ReturnType)E_OK;

#if (STD_ON == PORT_DEV_ERROR_DETECT)
    /* Bit Offset and Table value for change direction flag word*/
    VAR(uint8,  AUTOMATIC) u8PinDescBitOffset1 = (uint8)((uint8)u16PinPad1 & SIUL2_BIT_OFFSET_MASK_U8);
    VAR(uint16, AUTOMATIC) u16PinChangeDirFlagWord1 = Port_Siul2_au16GPIODirChangeability[(uint8)(u16PinPad1>>4)];

    VAR(uint8,  AUTOMATIC) u8PinDescBitOffset2 = (uint8)((uint8)u16PinPad2 & SIUL2_BIT_OFFSET_MASK_U8);
    VAR(uint16, AUTOMATIC) u16PinChangeDirFlagWord2 = Port_Siul2_au16GPIODirChangeability[(uint8)(u16PinPad2>>4)];
#endif /* (STD_ON == PORT_DEV_ERROR_DETECT) */
    ...
    */
       ...
       )
    {
        ...
        if (PORT_PIN_OUT == eDirection)
        {
            ...
            * @violates @ref Port_Siul2_C_REF_8 A cast should not be performed between a pointer type and an integral type.
            */
            REG_BIT_CLEAR32(SIUL2_MSCR_ADDR32((uint32)u16PinPad1), SIUL2_MSCR_IBE_ON_U32);
            /** 
            * @violates @ref Port_Siul2_C_REF_4 Cast from unsigned long to pointer.
            * @violates @ref Port_Siul2_C_REF_8 A cast should not be performed between a pointer type and an integral type.
            */
            REG_BIT_CLEAR32(SIUL2_MSCR_ADDR32((uint32)u16PinPad2), SIUL2_MSCR_IBE_ON_U32);
            ...
            * @violates @ref Port_Siul2_C_REF_6 Violates MISRA 2004 Required Rule 17.4
            */
            REG_RMW32(SIUL2_MSCR_ADDR32((uint32)u16PinPad1), SIUL2_MSCR_ODC_U32, pConfigPtr->pUsedPadConfig[Pin1Index].u32ODC & SIUL2_MSCR_ODC_U32);
            /**
            * @violates @ref Port_Siul2_C_REF_4 Violates MISRA 2004 Required Rule 11.1, cast from unsigned long to pointer
            * @violates @ref Port_Siul2_C_REF_8 A cast should not be performed between a pointer type and an integral type.
            * @violates @ref Port_Siul2_C_REF_6 Violates MISRA 2004 Required Rule 17.4
            */
            REG_RMW32(SIUL2_MSCR_ADDR32((uint32)u16PinPad2), SIUL2_MSCR_ODC_U32, pConfigPtr->pUsedPadConfig[Pin2Index].u32ODC & SIUL2_MSCR_ODC_U32);
#else
            /**
            * @violates @ref Port_Siul2_C_REF_4 Cast from unsigned long to pointer.
            * @violates @ref Port_Siul2_C_REF_8 A cast should not be performed between a pointer type and an integral type.
            */
            REG_BIT_SET32(SIUL2_MSCR_ADDR32((uint32)u16PinPad1), SIUL2_MSCR_OBE_ON_U32);
            /** 
            * @violates @ref Port_Siul2_C_REF_4 Cast from unsigned long to pointer.
            * @violates @ref Port_Siul2_C_REF_8 A cast should not be performed between a pointer type and an integral type.
            */
            REG_BIT_SET32(SIUL2_MSCR_ADDR32((uint32)u16PinPad2), SIUL2_MSCR_OBE_ON_U32);
#endif
        }
        /* Configures Port Pin as Input */
        else if (PORT_PIN_IN == eDirection)
        {
            ...
            * @violates @ref Port_Siul2_C_REF_8 A cast should not be performed between a pointer type and an integral type.
            */
            REG_BIT_CLEAR32(SIUL2_MSCR_ADDR32((uint32)u16PinPad1), SIUL2_MSCR_ODC_U32);
            /**
            * @violates @ref Port_Siul2_C_REF_4 Violates MISRA 2004 Required Rule 11.1, cast from unsigned long to pointer.
            * @violates @ref Port_Siul2_C_REF_8 A cast should not be performed between a pointer type and an integral type.
            */
            REG_BIT_CLEAR32(SIUL2_MSCR_ADDR32((uint32)u16PinPad2), SIUL2_MSCR_ODC_U32);
#else
            /**
            * @violates @ref Port_Siul2_C_REF_4 Cast from unsigned long to pointer.
            * @violates @ref Port_Siul2_C_REF_8 A cast should not be performed between a pointer type and an integral type.
            */
            REG_BIT_CLEAR32(SIUL2_MSCR_ADDR32((uint32)u16PinPad1), SIUL2_MSCR_OBE_ON_U32);
            /**
            * @violates @ref Port_Siul2_C_REF_4 Cast from unsigned long to pointer.
            * @violates @ref Port_Siul2_C_REF_8 A cast should not be performed between a pointer type and an integral type.
            */
            REG_BIT_CLEAR32(SIUL2_MSCR_ADDR32((uint32)u16PinPad2), SIUL2_MSCR_OBE_ON_U32);
#endif
            ...
            * @violates @ref Port_Siul2_C_REF_8 A cast should not be performed between a pointer type and an integral type.
            */
            REG_BIT_SET32(SIUL2_MSCR_ADDR32((uint32)u16PinPad1), SIUL2_MSCR_IBE_ON_U32);
            /**
            * @violates @ref Port_Siul2_C_REF_4 Cast from unsigned long to pointer.
            * @violates @ref Port_Siul2_C_REF_8 A cast should not be performed between a pointer type and an integral type.
            */
            REG_BIT_SET32(SIUL2_MSCR_ADDR32((uint32)u16PinPad2), SIUL2_MSCR_IBE_ON_U32);
        }
        else
        {
            /**
