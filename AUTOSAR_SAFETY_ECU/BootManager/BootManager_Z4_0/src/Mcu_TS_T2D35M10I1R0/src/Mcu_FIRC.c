...
#define Mcu_FIRC_AR_RELEASE_MINOR_VERSION_C       3
#define Mcu_FIRC_AR_RELEASE_REVISION_VERSION_C    1
#define Mcu_FIRC_SW_MAJOR_VERSION_C               1
#define Mcu_FIRC_SW_MINOR_VERSION_C               0
#define Mcu_FIRC_SW_PATCH_VERSION_C               1
...
#ifdef MCU_GET_FIRC_STATUS_USED
#if (MCU_GET_FIRC_STATUS_USED == STD_ON)
/**
...
#endif /* (MCU_GET_FIRC_STATUS_USED == STD_ON) */
#endif /* MCU_GET_FIRC_STATUS_USED */


#ifdef IPV_FIRC
#if (IPV_FIRC == IPV_FIRC_01_01_00_13)

#ifdef MCU_FIRC_STATUS_IN_STANDBY_USED
#if (MCU_FIRC_STATUS_IN_STANDBY_USED == STD_ON)
/**
...
#endif /* (MCU_FIRC_STATUS_IN_STANDBY_USED == STD_ON) */
#endif /* MCU_FIRC_STATUS_IN_STANDBY_USED */
