...
/** @violates @ref Mcu_MC_CGM_c_REF_3 MISRA 2004 Rule 1.4, The compiler/linker shall be checked to ensure that 31 character
*   significance and case sensitivity are supported for external identifiers. */
#define MCU_MC_CGM_AR_RELEASE_MINOR_VERSION_C       3
/** @violates @ref Mcu_MC_CGM_c_REF_3 MISRA 2004 Rule 1.4, The compiler/linker shall be checked to ensure that 31 character
*   significance and case sensitivity are supported for external identifiers. */
#define MCU_MC_CGM_AR_RELEASE_REVISION_VERSION_C    1
#define MCU_MC_CGM_SW_MAJOR_VERSION_C               1
#define MCU_MC_CGM_SW_MINOR_VERSION_C               0
#define MCU_MC_CGM_SW_PATCH_VERSION_C               1
...
#if (STD_ON == MCU_CGM_REG_PROT_AVAILABLE)
/**
...
FUNC( void, MCU_CODE) Mcu_MC_CGM_SetUserAccessAllowed(void)
{
    ...
    SET_USER_ACCESS_ALLOWED(MC_CGM_0_BASEADDR, MC_CGM_0_PROT_MEM_U32);
    /** @violates @ref Mcu_MC_CGM_c_REF_4 Conversion from pointer to integer */
    /** @violates @ref Mcu_MC_CGM_c_REF_6 The cast is used to access memory mapped registers.*/
    SET_USER_ACCESS_ALLOWED(MC_CGM_1_BASEADDR, MC_CGM_1_PROT_MEM_U32);
    /** @violates @ref Mcu_MC_CGM_c_REF_4 Conversion from pointer to integer */
    /** @violates @ref Mcu_MC_CGM_c_REF_6 The cast is used to access memory mapped registers.*/
    SET_USER_ACCESS_ALLOWED(MC_CGM_2_BASEADDR, MC_CGM_2_PROT_MEM_U32);
    /** @violates @ref Mcu_MC_CGM_c_REF_4 Conversion from pointer to integer */
    /** @violates @ref Mcu_MC_CGM_c_REF_6 The cast is used to access memory mapped registers.*/
    SET_USER_ACCESS_ALLOWED(MC_CGM_3_BASEADDR, MC_CGM_3_PROT_MEM_U32);
#else
    /** @violates @ref Mcu_MC_CGM_c_REF_4 Conversion from pointer to integer */
    /** @violates @ref Mcu_MC_CGM_c_REF_6 The cast is used to access memory mapped registers.*/
    SET_USER_ACCESS_ALLOWED(MC_CGM_BASEADDR, MC_CGM_PROT_MEM_U32);
#endif
#else
    /** @violates @ref Mcu_MC_CGM_c_REF_4 Conversion from pointer to integer */
    /** @violates @ref Mcu_MC_CGM_c_REF_6 The cast is used to access memory mapped registers.*/
...
#endif /* (STD_ON == MCU_CGM_REG_PROT_AVAILABLE) */
...
#ifdef MCU_ENABLE_USER_MODE_SUPPORT
#if (STD_ON == MCU_ENABLE_USER_MODE_SUPPORT)
#if (STD_ON == MCU_SRC_REG_PROT_AVAILABLE)
/**
* @brief            This function will enable writing in User mode by configuring REG_PROT
*/
FUNC( void, MCU_CODE) Mcu_SRC_SetUserAccessAllowed(void)
{
    /** @violates @ref Mcu_MC_CGM_c_REF_4 Conversion from pointer to integer */
    /** @violates @ref Mcu_MC_CGM_c_REF_6 The cast is used to access memory mapped registers.*/
    SET_USER_ACCESS_ALLOWED(SRC_BASEADDR, MC_SRC_PROT_MEM_U32);
}
#endif /* (STD_ON == MCU_SRC_REG_PROT_AVAILABLE) */
#endif /* (STD_ON == MCU_ENABLE_USER_MODE_SUPPORT) */
#endif /* MCU_ENABLE_USER_MODE_SUPPORT */
#endif /* IPV_MC_06_00_00_10 */

#if (IPV_MC == IPV_MC_06_00_00_10)
/**
* @brief            This function will configure PLL clock sources
*/
FUNC( void, MCU_CODE) Mcu_SRC_ConfigPllClockSources(VAR( Mcu_SRC_ConfigType, AUTOMATIC) SRC_ClockConfig)
{
    /** @violates @ref Mcu_MC_CGM_c_REF_4 Conversion from pointer to integer */
    /** @violates @ref Mcu_MC_CGM_c_REF_6 The cast is used to access memory mapped registers.*/
...
#ifdef MCU_ERR10393_IPV_MC_04060500
#if (MCU_ERR10393_IPV_MC_04060500 == STD_ON)
            /* Configure the clock selection required for Clk_Out1 */
            /** @violates @ref Mcu_MC_CGM_c_REF_4 Conversion from pointer to integer */
            /** @violates @ref Mcu_MC_CGM_c_REF_6 The cast is used to access memory mapped registers.*/
            REG_RMW32( MC_CGM_AC14_SC_ADDR32, MC_CGM_AC9_SC_SELCTL_MASK32, u32ClockoutSelectValue );
#endif  /* MCU_ERR10393_IPV_MC_04060500 */
#endif  /* (MCU_ERR10393_IPV_MC_04060500 == STD_ON) */
        }
...
#ifdef MCU_ERR10393_IPV_MC_04060500
#if (MCU_ERR10393_IPV_MC_04060500 == STD_ON)
            /* Configure the clock selection required for Clk_Out0 */
            /** @violates @ref Mcu_MC_CGM_c_REF_4 Conversion from pointer to integer */
            /** @violates @ref Mcu_MC_CGM_c_REF_6 The cast is used to access memory mapped registers.*/
            REG_RMW32( MC_CGM_AC14_SC_ADDR32, MC_CGM_AC14_SC_SELCTL_MASK32, u32ClockoutSelectValue );
#endif  /* MCU_ERR10393_IPV_MC_04060500 */
#endif  /* (MCU_ERR10393_IPV_MC_04060500 == STD_ON) */
        }
        else
...
#if (IPV_MC == IPV_MC_06_00_00_10)
    /* configure Enet clock mode */
    /** @violates @ref Mcu_MC_CGM_c_REF_4 Conversion from pointer to integer */
    /** @violates @ref Mcu_MC_CGM_c_REF_6 The cast is used to access memory mapped registers.*/
    REG_RMW32(SRC_GPR3_ADDR32, SRC_GPR3_ENET_MODE_MASK, MC_CGM_pClockConfigPtr->u32EnetClockModeSelect);
#endif
}
