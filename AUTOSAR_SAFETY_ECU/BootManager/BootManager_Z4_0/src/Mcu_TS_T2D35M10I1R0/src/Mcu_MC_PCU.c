...
/** @violates @ref Mcu_MC_PCU_c_REF_3 MISRA 2004 Required Rule 1.4, The compiler/linker shall be checked ... */
#define MCU_MC_PCU_AR_RELEASE_MINOR_VERSION_C       3
/** @violates @ref Mcu_MC_PCU_c_REF_3 MISRA 2004 Required Rule 1.4, The compiler/linker shall be checked ... */
#define MCU_MC_PCU_AR_RELEASE_REVISION_VERSION_C    1
#define MCU_MC_PCU_SW_MAJOR_VERSION_C               1
#define MCU_MC_PCU_SW_MINOR_VERSION_C               0
#define MCU_MC_PCU_SW_PATCH_VERSION_C               1
...
#ifdef MCU_PCU_REG_PROT_AVAILABLE
#if (STD_ON == MCU_PCU_REG_PROT_AVAILABLE)
/**
* @brief            This function will enable writing in User mode by configuring REG_PROT
*/
FUNC( void, MCU_CODE) Mcu_PCU_SetUserAccessAllowed(void)
{
    /** @violates @ref Mcu_MC_PCU_c_REF_4 Cast from unsigned long to pointer.*/
    /** @violates @ref Mcu_MC_PCU_c_REF_6 The cast is used to access memory mapped registers.*/
    SET_USER_ACCESS_ALLOWED(PCU_BASEADDR, PCU_PROT_MEM_U32);
}
#endif /* (STD_ON == MCU_PCU_REG_PROT_AVAILABLE) */
#endif /* MCU_PCU_REG_PROT_AVAILABLE */
...
FUNC( void, MCU_CODE) Mcu_PMU_VoltageErrorInt( VAR( void, AUTOMATIC) )
{
    ...
    /** @violates @ref Mcu_MC_PCU_c_REF_4 Required Rule 11.1, Conversion from integer to pointer */
    /** @violates @ref Mcu_MC_PCU_c_REF_6 The cast is used to access memory mapped registers.*/
    REG_WRITE_LOCK32( PMC_BASEADDR, PMC_ESR_0_ADDR32, u32PmcVoltageEvent);
...
FUNC( void, MCU_CODE) Mcu_PMU_TemperatureErrorInt( VAR( void, AUTOMATIC) )
{
    ...
    /** @violates @ref Mcu_MC_PCU_c_REF_4 Conversion from integer to pointer */
    /** @violates @ref Mcu_MC_PCU_c_REF_6 The cast is used to access memory mapped registers.*/
    REG_WRITE_LOCK32( PMC_BASEADDR, PMC_ESR_TD_ADDR32, u32PmcTempEvent);
