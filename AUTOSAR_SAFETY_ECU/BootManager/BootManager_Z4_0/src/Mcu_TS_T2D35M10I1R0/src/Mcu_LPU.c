...
#define Mcu_LPU_AR_RELEASE_MINOR_VERSION_C       3
#define Mcu_LPU_AR_RELEASE_REVISION_VERSION_C    1
#define Mcu_LPU_SW_MAJOR_VERSION_C               1
#define Mcu_LPU_SW_MINOR_VERSION_C               0
#define Mcu_LPU_SW_PATCH_VERSION_C               1
...
#if (STD_ON == MCU_LPU_REG_PROT_AVAILABLE)
/**
...
FUNC( void, MCU_CODE) Mcu_LPU_SetUserAccessAllowed(void)
{
    ...
    SET_USER_ACCESS_ALLOWED(LPU_BASEADDR, LPU_PROT_MEM_U32);
}
#endif /* (STD_ON == MCU_LPU_REG_PROT_AVAILABLE) */
...
static FUNC( void, AUTOMATIC) Mcu_LPU_ApplyMode(VAR(Mcu_LpuModeType, AUTOMATIC) eLowPowerMode);
#endif
...
static FUNC( void, AUTOMATIC) Mcu_LPU_ApplyMode(VAR(Mcu_LpuModeType, AUTOMATIC) eLowPowerMode)
{
    ...
    if ( (uint32)0x0U == u32TimeOut)
    {
        ...
        {
            /** @violates @ref Mcu_LPU_c_REF_6 The returning shall be tested if error. */
