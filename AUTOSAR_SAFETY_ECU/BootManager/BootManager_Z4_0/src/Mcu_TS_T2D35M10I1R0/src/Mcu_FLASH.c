...
/** @violates @ref Mcu_FLASH_c_REF_3 MISRA 2004 Rule 1.4, The compiler/linker shall be checked to ensure that 31 character
*   significance and case sensitivity are supported for external identifiers. */
#define MCU_FLASH_AR_RELEASE_MINOR_VERSION_C        3
/** @violates @ref Mcu_FLASH_c_REF_3 MISRA 2004 Rule 1.4, The compiler/linker shall be checked to ensure that 31 character
*   significance and case sensitivity are supported for external identifiers. */
#define MCU_FLASH_AR_RELEASE_REVISION_VERSION_C     1
#define MCU_FLASH_SW_MAJOR_VERSION_C                1
#define MCU_FLASH_SW_MINOR_VERSION_C                0
#define MCU_FLASH_SW_PATCH_VERSION_C                1
...
#ifdef MCU_DISABLE_FLASH_CONFIG
...
#endif /*MCU_DISABLE_FLASH_CONFIG*/
...
#ifdef MCU_DISABLE_FLASH_CONFIG
#if (MCU_DISABLE_FLASH_CONFIG == STD_OFF)
P2FUNC(void, MCU_CODE, Mcu_FLASH_pfInit) (P2CONST(Mcu_FLASH_ConfigType, AUTOMATIC, MCU_APPL_CONST) FLASH_pConfigPtr) = &Mcu_FLASH_InitRam;
#endif /*MCU_DISABLE_FLASH_CONFIG == STD_OFF*/
#endif /*MCU_DISABLE_FLASH_CONFIG*/
...
P2FUNC(void, MCU_CODE, Mcu_FLASH_pfSetWS) (P2CONST(Mcu_FLASH_ClockConfigType, AUTOMATIC, MCU_APPL_CONST) FLASH_pClockConfigPtr) = &Mcu_FLASH_SetWsRam;
#endif /*MCU_DISABLE_FLASH_CONFIG == STD_OFF*/
#endif /*MCU_DISABLE_FLASH_CONFIG*/
#endif /* (MCU_INIT_CLOCK == STD_ON) */
