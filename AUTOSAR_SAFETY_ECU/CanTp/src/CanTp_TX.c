...
Std_ReturnType CanTp_Transmit ( PduIdType TxPduId, const PduInfoType* PduInfoPtr )
{
	...
	//TODO: look up addressInfo, messageType based on pduId
	N_AI addressInfo =
	{
			.N_SA = 0xff,
			.N_TA = 0x55,
...
//{
//    TimerType_t timerType= (TimerType_t)lpParam;
//
//    switch (timerType)
//    {
//    case ST_MIN_TIMER:
...
//                    WAIT_FC_FRAME(MAX_WAIT_FOR_FC_FRAME_IN_SECONDS);
//
//                    // TODO: start FC frame wait timer
...
//    if(NULL != hTimerQueue)
//    {
//        // Create a timer in the queue
//        if (!CreateTimerQueueTimer(
//                &hTimer,           // Timer handle
//                hTimerQueue,       // Timer queue
//                TimerCallback,     // Callback function
//                (PVOID)timerType,  // Parameter to pass to callback (optional)
//                time_sec*1000,     // Initial delay
//                0,                 // Interval (0 second)
