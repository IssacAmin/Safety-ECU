...
/**
    ...
    ARConfVariant
    SWVersion 1.0.1
    BuildVersion MPC574XG_MCAL_1_0_1_RTM_HF6_ASR_REL_4_3_REV_0001_20210223
...
static CONST( Mcu_FLASH_ClockConfigType, MCU_CONST) FLASH_ClockConfigPB0_0 = 
{
    ...
    ( 
        ...
        MCU_FLASH_READ_WS_U32((uint32)0)
    )
};
#endif /* (MCU_DISABLE_FLASH_CONFIG == STD_ON) */
...
#if (MCU_INIT_CLOCK == STD_ON)
/** @violates @ref Mcu_PBcfg_c_REF_3 MISRA 2004 Required Rule 1.4, 31 characters limit.*/
static CONST( Mcu_MC_CGM_RegisterConfigType, MCU_CONST) MC_CGM_aAuxClockConfigPB0_0[11] = 
{
    ...
    /* Auxiliary Clock5 Source Selection. */
    {
        ...
        MC_CGM_AUXCLK5_U32(MC_CGM_AUXCLK5_SOURCE_FIRC_U32)
    }
...
static CONST( Mcu_PLLDIG_RegisterConfigType, MCU_CONST) Mcu_PLLDIG_aRegistersConfigPB0_0[6U] = 
{
    ...
    /* PLL0 configuration */
    {
        ...
        MCU_PLLDIG_PLL0CAL3_U32( MCU_PLLDIG_PLL0CAL3_MDFEN_U32( (uint32)1U ) )
    },
        {
    ...
    },
    {
        ...
        MCU_PLLDIG_PLL0DV_U32(
            ...
            MCU_PLLDIG_PLL0DV_MFD_U32( (uint32)40U )
        )
    },
    {
...
static CONST( Mcu_ClockConfigType, MCU_CONST) Mcu_aClockConfigPB0[1] =  
{
    ...
    /* Start of Mcu_ClockConfig[0]. */
    {
        ...
        (
MC_ME_SYSCLK_FIRC_U32 | MC_ME_FIRC_EN_U32
        ),
        ...
        ( MCU_IPW_FIRC_UNDER_MCU_CONTROL | 
         ...
         MCU_IPW_SXOSC_NOT_UNDER_MCU_CONTROL | 
         MCU_IPW_FXOSC_NOT_UNDER_MCU_CONTROL  | 
...
static CONST( Mcu_MC_ME_RegisterConfigType, MCU_CONST) MC_ME_aPCTLConfigPB0[MCU_MC_ME_NUMBER_OF_PCTL_REGS] = 
{
    ...
    {
        MC_ME_PCTL1_ADDR32,
        MC_ME_PCTLn_U8(MC_ME_PCTL_DBG_FRZ_DIS_U8, MC_ME_CFG_RUN_PC2_U8, MC_ME_CFG_LP_PC0_U8)
    },
    ...
    {
        MC_ME_PCTL3_ADDR32,
        MC_ME_PCTLn_U8(MC_ME_PCTL_DBG_FRZ_DIS_U8, MC_ME_CFG_RUN_PC0_U8, MC_ME_CFG_LP_PC1_U8)
    },

    /* PCTL4_USB_OTG */
    {
        MC_ME_PCTL4_ADDR32,
        MC_ME_PCTLn_U8(MC_ME_PCTL_DBG_FRZ_DIS_U8, MC_ME_CFG_RUN_PC1_U8, MC_ME_CFG_LP_PC1_U8)
    },
    ...
    {
        MC_ME_PCTL24_ADDR32,
        MC_ME_PCTLn_U8(MC_ME_PCTL_DBG_FRZ_DIS_U8, MC_ME_CFG_RUN_PC1_U8, MC_ME_CFG_LP_PC2_U8)
    },
    ...
    {
        MC_ME_PCTL41_ADDR32,
        MC_ME_PCTLn_U8(MC_ME_PCTL_DBG_FRZ_DIS_U8, MC_ME_CFG_RUN_PC2_U8, MC_ME_CFG_LP_PC1_U8)
    },
    ...
    {
        MC_ME_PCTL71_ADDR32,
        MC_ME_PCTLn_U8(MC_ME_PCTL_DBG_FRZ_EN_U8, MC_ME_CFG_RUN_PC0_U8, MC_ME_CFG_LP_PC0_U8)
    },
    ...
    {
        MC_ME_PCTL97_ADDR32,
        MC_ME_PCTLn_U8(MC_ME_PCTL_DBG_FRZ_DIS_U8, MC_ME_CFG_RUN_PC6_U8, MC_ME_CFG_LP_PC1_U8)
    },
...
static CONST( Mcu_MC_ME_ConfigType, MCU_CONST) MC_ME_ConfigPB0 =
{
    ...
    (
        (MC_ME_RUN3_CLK_GATED_U32) |
        (MC_ME_RUN2_CLK_GATED_U32) |
        (MC_ME_RUN1_CLK_GATED_U32) |
        (MC_ME_RUN0_CLK_GATED_U32) |
        (MC_ME_DRUN_CLK_ACTIVE_U32) |
        (MC_ME_SAFE_CLK_GATED_U32) |
        (MC_ME_TEST_CLK_GATED_U32)
    ),
