...
#define MBEDTLS_ECP_DP_SECP256R1_ENABLED // NIST P-256 (what commonly used for ECDSA verification)

// Hash
#define MBEDTLS_SHA256_C

// ASN1 parsing for signature DER decoding
#define MBEDTLS_ASN1_PARSE_C

// Needed for error messages
#define MBEDTLS_ERROR_C

// Needed for platform functions (snprintf, zeroize, etc)
#define MBEDTLS_PLATFORM_C
